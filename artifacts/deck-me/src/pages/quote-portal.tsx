...
export default function QuotePortalPage() {
      ...
      },
      {
        ...
        onError: async (error) => {
          ...
          toast({
            ...
            description:
              "Please try your selection again before accepting the quote.",
            variant: "destructive",
          });
        },
      },
        ...
        { token, data: { status: "accepted" } },
        {
          ...
          onError: () => {
            ...
            toast({
              ...
              description:
                "Please try again. Your selection has not been accepted.",
              variant: "destructive",
            });
          },
        },
      ...
      <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-background p-6">
        <div className="bg-white p-8 rounded-xl shadow-sm border max-w-md w-full text-center">
          ...
          <p className="text-muted-foreground mb-6">
            We couldn't load this quote. The link may have expired or is
            incorrect.
          </p>
        </div>
      </div>
  ...
  const displaySubtotal = estimate
    ? estimate.materialsSubtotal + estimate.labourCost
    : quote.materialsSubtotal + quote.labourCost;
      ...
      <header className="bg-secondary text-secondary-foreground py-6 px-6 md:px-12 sticky top-0 z-10 shadow-md">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 min-w-0">
            <img
              src={
                quote.businessLogoUrl.startsWith("http")
                  ? quote.businessLogoUrl
                  : `${basePath}${quote.businessLogoUrl}`
              }
              alt={`${quote.businessName || "Quote Master"} logo`}
            ...
            <div className="hidden sm:block min-w-0 border-l border-secondary-foreground/20 pl-4">
              <p className="font-display font-bold truncate">
                {quote.businessName || "Quote Master"}
              </p>
              <p className="text-xs text-secondary-foreground/60 truncate">
                {quote.businessTradeType || "Building services"}
                {quote.businessPhone ? ` · ${quote.businessPhone}` : ""}
              </p>
            </div>
          </div>
          {isAccepted && (
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <section>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
              Hi {quote.customerName?.split(" ")[0] || "there"}, here is the
              detailed breakdown for your new deck. Review the specifications
              below and customise your materials to see real-time pricing
              updates.
            </p>
          </section>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">
                    ...
                    <span className="text-xs text-muted-foreground/80">
                      Approx{" "}
                      {(quote.spec.lengthM * quote.spec.widthM).toFixed(1)}
                      m&sup2; area
                    </span>
                  </p>
                </div>
            ...
            <section className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Select your preferred materials below. The price will update
                  automatically.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
                <div className="p-5 md:p-6 border-b bg-muted/30">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Choose between natural timber or low-maintenance composite.
                  </p>
                </div>
                <div className="p-5 md:p-6 grid sm:grid-cols-2 gap-4">
                  <button
                    onClick={() =>
                      handleSpecChange({ deckBoardType: "treated_pine" })
                    }
                    className={`relative p-5 rounded-xl border-2 text-left transition-all duration-200 ${
                      activeSpec.deckBoardType === "treated_pine" ||
                      (!activeSpec.deckBoardType &&
                        quote.spec.deckBoardType === "treated_pine")
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                      Classic natural timber look. Requires regular oiling and
                      maintenance to preserve its colour and lifespan.
                    </p>
                  </button>

                  <button
                    onClick={() =>
                      handleSpecChange({ deckBoardType: "composite" })
                    }
                    className={`relative p-5 rounded-xl border-2 text-left transition-all duration-200 ${
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                      Highly durable, rot-resistant, and virtually
                      maintenance-free. Never needs oiling or staining.
                    </p>
                  </button>
                </div>
              </div>
              ...
              {activeSpec.includeHandrails && (
                <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
                  <div className="p-5 md:p-6 border-b bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Select the infill style for your handrails.
                    </p>
                  </div>
                  <div className="p-5 md:p-6 grid sm:grid-cols-2 gap-4">
                    <button
                      onClick={() =>
                        handleSpecChange({ balustradeType: "timber" })
                      }
                      className={`relative p-5 rounded-xl border-2 text-left transition-all duration-200 ${
                        activeSpec.balustradeType === "timber" ||
                        (!activeSpec.balustradeType &&
                          quote.spec.balustradeType === "timber")
                          ? "border-primary bg-primary/5 ring-4 ring-primary/10"
                          : "border-border hover:border-primary/40 bg-white"
                      }`}
                    >
                      ...
                      <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                        Traditional vertical timber slats for a robust, classic
                        enclosure.
                      </p>
                    </button>
                    ...
                    <button
                      onClick={() =>
                        handleSpecChange({ balustradeType: "stainless_cable" })
                      }
                      className={`relative p-5 rounded-xl border-2 text-left transition-all duration-200 ${
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                        Sleek horizontal wire balustrades that preserve your
                        view and offer a modern finish.
                      </p>
                    </button>
                  </div>
                </div>
            ...
            <div className="bg-green-50 rounded-2xl border border-green-200 p-8 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-green-800 leading-relaxed">
                  Thank you for accepting this quote! Your chosen specifications
                  have been locked in. Our team will be in touch shortly to
                  finalise the timeline and arrange your booking.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="bg-secondary rounded-2xl shadow-xl overflow-hidden border border-secondary-border">
              <div className="p-6 md:p-8 text-secondary-foreground">
                ...
                <div className="space-y-4">
                  {displayLineItems.map((item, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-start border-b border-secondary-foreground/10 pb-4 last:border-0 last:pb-0"
                    >
                      <div className="pr-4">
                        ...
                        <p className="text-xs text-secondary-foreground/60 mt-1">
                          {item.quantity} {item.unitType || item.unit} &times;{" "}
                  ...
                  <div className="flex justify-between items-start border-b border-secondary-foreground/10 pb-4">
                    ...
                    <p className="font-semibold shrink-0">
                      {formatCurrency(
                        estimate ? estimate.labourCost : quote.labourCost,
                      )}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-secondary-foreground/5 p-6 md:p-8">
                ...
                <div className="flex justify-between items-end border-t border-secondary-foreground/10 pt-6 mb-8 relative">
                  <div>
                    <span className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                      Total Due
                    </span>
            ...
            <div className="bg-white p-6 rounded-2xl border shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  If you need any adjustments to the dimensions or scope not
                  listed above, please contact your builder directly before
                  accepting.
                </p>
              </div>
            </div>
