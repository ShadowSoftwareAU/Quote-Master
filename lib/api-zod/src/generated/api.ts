...
export const createQuoteBodyLineItemsItemQuantityMax = 100000;

export const createQuoteBodyLineItemsItemUnitCostMin = 0;
export const createQuoteBodyLineItemsItemUnitCostMax = 9000;

export const createQuoteBodyLineItemsItemMarkupPercentageMin = 0;
export const createQuoteBodyLineItemsItemMarkupPercentageMax = 1000;
...
export const getLatestCadLayoutResponseComplianceEvaluatedStandardsMin = 4;
export const getLatestCadLayoutResponseComplianceEvaluatedStandardsMax = 4;

export const getLatestCadLayoutResponseComplianceFindingsItemCodeMax = 100;

export const getLatestCadLayoutResponseComplianceFindingsItemTitleMax = 200;

export const getLatestCadLayoutResponseComplianceFindingsItemMessageMax = 1000;

export const getLatestCadLayoutResponseComplianceFindingsItemComponentIdsItemMax = 100;

export const getLatestCadLayoutResponseComplianceFindingsMax = 100;
...
export const GetLatestCadLayoutResponse = zod.object({
  ...
  "x": zod.number().gt(getLatestCadLayoutResponseLayoutDimensionsXExclusiveMin),
  "y": zod.number().gt(getLatestCadLayoutResponseLayoutDimensionsYExclusiveMin),
  "z": zod.number().gt(getLatestCadLayoutResponseLayoutDimensionsZExclusiveMin)
}),
  "origin": zod.object({
  "x": zod.number(),
  "y": zod.number(),
  ...
  "structuralComponents": zod.array(zod.object({
  "id": zod.string().min(1).max(getLatestCadLayoutResponseLayoutStructuralComponentsItemIdMax),
  "name": zod.string().min(1).max(getLatestCadLayoutResponseLayoutStructuralComponentsItemNameMax),
  "type": zod.enum(['beam', 'post', 'joist', 'wall', 'decking-board', 'handrail', 'conduit', 'cable', 'outlet', 'junction-box', 'pipe', 'fitting', 'fixture']),
  "tradeCategory": zod.enum(['carpentry', 'electrical', 'plumbing']),
  "material": zod.string().min(1).max(getLatestCadLayoutResponseLayoutStructuralComponentsItemMaterialMax),
  "materialSku": zod.string().min(1).max(getLatestCadLayoutResponseLayoutStructuralComponentsItemMaterialSkuMax).nullable(),
  "geometryId": zod.string().min(1).max(getLatestCadLayoutResponseLayoutStructuralComponentsItemGeometryIdMax),
  "dimensions": zod.object({
  "x": zod.number().gt(getLatestCadLayoutResponseLayoutStructuralComponentsItemDimensionsXExclusiveMin),
  "y": zod.number().gt(getLatestCadLayoutResponseLayoutStructuralComponentsItemDimensionsYExclusiveMin),
  "z": zod.number().gt(getLatestCadLayoutResponseLayoutStructuralComponentsItemDimensionsZExclusiveMin)
}),
  "position": zod.object({
  "x": zod.number(),
  "y": zod.number(),
...
})).min(1).max(getLatestCadLayoutResponseLayoutStructuralComponentsMax)
}),
  "compliance": zod.object({
  "version": zod.number(),
  "status": zod.enum(['pass', 'warning', 'block']),
  "evaluatedStandards": zod.array(zod.enum(['NCC 2022', 'AS 1684', 'AS/NZS 3000', 'AS/NZS 3500'])).min(getLatestCadLayoutResponseComplianceEvaluatedStandardsMin).max(getLatestCadLayoutResponseComplianceEvaluatedStandardsMax),
  "findings": zod.array(zod.object({
  "code": zod.string().min(1).max(getLatestCadLayoutResponseComplianceFindingsItemCodeMax),
  "standard": zod.enum(['NCC 2022', 'AS 1684', 'AS/NZS 3000', 'AS/NZS 3500']),
  "severity": zod.enum(['warning', 'block']),
  "title": zod.string().min(1).max(getLatestCadLayoutResponseComplianceFindingsItemTitleMax),
  "message": zod.string().min(1).max(getLatestCadLayoutResponseComplianceFindingsItemMessageMax),
  "componentIds": zod.array(zod.string().min(1).max(getLatestCadLayoutResponseComplianceFindingsItemComponentIdsItemMax))
})).max(getLatestCadLayoutResponseComplianceFindingsMax)
}),
  "createdAt": zod.coerce.date(),
  "updatedAt": zod.coerce.date()
})
